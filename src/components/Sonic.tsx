...
function Sonic() {
    ...
    return (
        <div className="min-h-[110vh] grid gap-4 grid-cols-1 lg:grid-cols-7 overflow-hidden">
            ...
            <div className="col-span-1 lg:col-span-4 bg-[#faefe5] px-6 sm:px-8 lg:px-10 py-10 sm:py-14 lg:py-20 flex flex-col justify-between gap-16 lg:gap-40 items-center">
                <p
                    ref={paragraphRef}
                    className="drop-cap-text fontDomine text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-[2.8rem] 2xl:text-[3.2rem] min-[1900px]:text-[3.5rem] leading-relaxed text-black"
                ...
                <div
                    ref={boxRef}
                    className="w-full lg:w-[40vw] min-h-[300px] sm:min-h-[350px] lg:min-h-[50vh] bg-[#fff2db] -rotate-3 outline-2 shadow-lg p-6 sm:p-8 lg:p-10 flex items-center justify-center"
                >
